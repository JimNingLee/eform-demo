...
public class PdfFormPdfExporterTagHelper
{
	private final String EFORM_EXPORTER_PROPERTIES_PREFIX = RXPropertiesUtil.PROPERTY_PREFIX + "export.html.";
	
	public final String PROPERTY_TAG_TABLE = EFORM_EXPORTER_PROPERTIES_PREFIX + "tag.table";
	public final String PROPERTY_TAG_TR = EFORM_EXPORTER_PROPERTIES_PREFIX + "tag.tr";
	public final String PROPERTY_TAG_TH = EFORM_EXPORTER_PROPERTIES_PREFIX + "tag.th";
	public final String PROPERTY_TAG_TD = EFORM_EXPORTER_PROPERTIES_PREFIX + "tag.td";
	public final String PROPERTY_TAG_H1 = EFORM_EXPORTER_PROPERTIES_PREFIX + "tag.h1";
	public final String PROPERTY_TAG_H2 = EFORM_EXPORTER_PROPERTIES_PREFIX + "tag.h2";
	public final String PROPERTY_TAG_H3 = EFORM_EXPORTER_PROPERTIES_PREFIX + "tag.h3";
	public final String PROPERTY_TAG_COLSPAN = EFORM_EXPORTER_PROPERTIES_PREFIX + "tag.colspan";
	public final String PROPERTY_TAG_ROWSPAN = EFORM_EXPORTER_PROPERTIES_PREFIX + "tag.rowspan";
	public final String TAG_START = "start";
	public final String TAG_END = "end";
	public final String TAG_FULL = "full";
	
	protected PdfFormPdfExporter exporter;
	 ...
	 *
	 */
	protected PdfFormPdfExporterTagHelper(PdfFormPdfExporter exporter)
	{
