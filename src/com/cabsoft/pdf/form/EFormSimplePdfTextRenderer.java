 ...
 */
public class EFormSimplePdfTextRenderer extends PdfFormAbstractPdfTextRenderer
{
	/**
	 * @deprecated Replaced by {@link #SimplePdfTextRenderer(RXReportsContext, boolean)}.
	 */
	public static EFormSimplePdfTextRenderer getInstance()
	{
		return 
	 ...
	 * @deprecated Replaced by {@link #SimplePdfTextRenderer(RXReportsContext, boolean)}.
	 */
	public EFormSimplePdfTextRenderer(boolean ignoreMissingFont)
	{
	 ...
	 * 
	 */
	public EFormSimplePdfTextRenderer(RXReportsContext rXReportsContext, boolean ignoreMissingFont)
	{
