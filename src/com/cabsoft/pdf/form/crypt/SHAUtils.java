/*
 * Copyright (c) 2009-2010 RedFox KOREA,
 *                    All Rights Reserved.
 *
 * [개발정보]
 * 만든이 : RedFox
 * 만든곳 : RedFox KOREA(http://korea.blogsite.org)
 * 만든날 : 2009. 12. 10
 *
 */
...
public class SHAUtils {
     ...
     */
    public static byte[] getHash(InputStream input) throws IOException, Exception {
        try {
            MessageDigest md = MessageDigest.getInstance(ALGORITHM);
            int read = -1;
     ...
     */
    public static String getHashHexString(byte[] input) throws Exception {
     ...
     * @return 16진수 문자열로 변환한
     */
    public static String getHashHexString(String input) throws Exception {
     ...
     */
    public static String getHashHexString(String input, String charsetName) throws Exception {
     ...
     * @throws IOException 입/출력 에러발생시
     */
    public static String getHashHexString(InputStream input) throws Exception {
        byte[] hash = getHash(input);
     ...
     * @throws IOException 입/출력 에러발생시
     */
    public static String getHashHexString(File file) throws Exception {
