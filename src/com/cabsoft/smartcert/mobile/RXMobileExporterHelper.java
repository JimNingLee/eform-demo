...
public class RXMobileExporterHelper {

	// private static final double scale = 96.0 / 25.4;
	// private static final double ruler_sp = 10.0/5.0*scale+0.745;

	/*
	 * 보고서의 페이지 수와 페이지의 폭 그리고 높이를 픽셀 단위로 넘겨받아 자바스크립트 변수에 할당한다.
	 */
	public static String setMaxPages(int maxpages, double pageWidth, double pageHeight) {
	 ...
	 * 문서의 스타일을 정의한다.
	 */
	public static String getDocStart(double pageWidth, double pageHeight, double left_margin, double right_margin) {
		...
		doc_start.append("<div id=\"doc\" style=\"left: 55px; top: 10px;\" class=\"rxe-paginateddocumentplugin\">");
	...
	public static String getDocEnd() {
		 ...
		 * doc_end.append("</form>"); doc_end.append("</body>");
		 * doc_end.append("</html>");
		 */
	 ...
	 * 보고서 페이지의 시작 부분
	 */
	public static String getPageStart(double screenW, double screenH) {
