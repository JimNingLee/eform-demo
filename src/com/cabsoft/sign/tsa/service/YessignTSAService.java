...
public class YessignTSAService {
	private static final Log log = LogFactory.getLog(YessignTSAService.class);
	...
	public static PdfPKCS7Info signPdfWithTSAOCSP(OutputStream out, ByteArrayOutputStream o, String webinf, String pwd, 
		...
		String TSA_URL = globalParams.getProperty("com.cabsoft.yessign.url");
		String TSA_ACCNT = globalParams.getProperty("com.cabsoft.yessign.userid");
		String TSA_PASSW = globalParams.getProperty("com.cabsoft.yessign.password");

		TSAClient tsc = new TSAClientSpongyCastle(TSA_URL, TSA_ACCNT, TSA_PASSW, 4096, globalParams.getProperty("com.cabsoft.yessign.alg"));
		...
		String tsaSignCert = globalParams.getProperty("com.cabsoft.yessign.sign.cert");
		String tsaPrivateKey = globalParams.getProperty("com.cabsoft.yessign.sign.privatekey");
		String tsaPriPwd = globalParams.getProperty("com.cabsoft.yessign.sign.password");
		String certPath = globalParams.getCabsoftPath() + "cert" + SystemUtils.FILE_SEPARATOR;
		 ...
		 * if(SignCertFactory.getInstance().getTsaKmCert()==null){ kmCertUtil =
		 * new SignCertUtil(certPath+kmCert, certPath+kmPrivateKey, kmPriPwd);
		 * SignCertFactory.getInstance().setTsaKmCert(kmCertUtil); }else{
		 ...
		 */
		certInfo.setSealImage("yessign_c" + String.valueOf(globalParams.getDefaultTimestamp()) + ".png");
