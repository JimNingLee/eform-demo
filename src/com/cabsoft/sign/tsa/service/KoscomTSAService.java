...
public class KoscomTSAService {
	private static final Log log = LogFactory.getLog(KoscomTSAService.class);
	...
	public static PdfPKCS7Info signPdfWithTSAOCSP(OutputStream out, ByteArrayOutputStream o, String webinf, String pwd,
		...
		String TSA_URL = globalParams.getProperty("com.cabsoft.koscom.url");
		String TSA_ACCNT = globalParams.getProperty("com.cabsoft.koscom.userid");
		String TSA_PASSW = globalParams.getProperty("com.cabsoft.koscom.password");

		TSAClient tsc = new TSAClientSpongyCastle(TSA_URL, TSA_ACCNT, TSA_PASSW, 4096, globalParams.getProperty("com.cabsoft.koscom.alg"));
		 ...
		 * 타임스탬프 기관
		 */
		certInfo.setTimeStampOrgan("koscom");
		 ...
		 */
		certInfo.setSealImage("koscom" + String.valueOf(globalParams.getDefaultTimestamp()) + ".png");
		 ...
		 * 검증 결과에 따른 인영 마크 설정
		 */
		certInfo.setShadowMark2(ImageToByte.getImage(certInfo.getTimeStampPath() + "koscom2.png"));
		certInfo.setShadowMark3(ImageToByte.getImage(certInfo.getTimeStampPath() + "koscom3.png"));
		certInfo.setShadowMark4(ImageToByte.getImage(certInfo.getTimeStampPath() + "koscom4.png"));
